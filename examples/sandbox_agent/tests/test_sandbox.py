...
class TestIPythonResult:
    """Tests for IPythonResult dataclass."""

    def test_success_property(self):
        result = IPythonResult(exit_code=0, text_output="42", error_output="")
        assert result.success is True

    def test_failure_property(self):
        result = IPythonResult(exit_code=1, text_output="", error_output="NameError")
        assert result.success is False

    def test_image_urls_default(self):
        result = IPythonResult(exit_code=0, text_output="", error_output="")
